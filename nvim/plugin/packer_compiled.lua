...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-tabnine", "cmp-nvim-lua", "cmp-vsnip", "cmp-treesitter", "cmp-path", "cmp-omni", "cmp-buffer", "cmp-nvim-tags", "cmp-spell" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-lsp-smag", "fidget.nvim", "nvim-lsp-installer" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'vim-smartchr', 'vim-vsnip', 'cosco.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'specs.nvim', 'indent-blankline.nvim', 'hop.nvim', 'quick-scope', 'nvim-cursorword', 'nvim-notify', 'vim-signify', 'faster.nvim', 'clever-f.vim', 'modes.nvim', 'vim-gutentags', 'Shade.nvim', 'mkdir.nvim', 'kommentary', 'vim-fugitive', 'nvim-hlslens', 'tagbar', 'asyncrun.vim', 'stickybuf.nvim', 'vimdoc-ja'}, { event = "VimEnter *" }, _G.packer_plugins)]]
