...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-spell" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-gps", "fidget.nvim", "nvim-lsp-smag", "lsp_signature.nvim", "nvim-lsp-installer" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'vim-smartchr', 'nvim-cmp', 'vim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-scrollbar', 'quick-scope', 'vim-cursorword', 'clever-f.vim', 'kommentary', 'tagbar', 'vim-fugitive', 'nvim-notify', 'vim-quickhl', 'vim-signify', 'asyncrun.vim', 'vimdoc-ja', 'faster.nvim', 'hop.nvim', 'indent-guides.nvim', 'nvim-hlslens', 'vim-gutentags', 'specs.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
