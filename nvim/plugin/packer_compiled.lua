...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp-spell", "cmp-tabnine", "cmp-vsnip", "cmp-treesitter", "cmp-omni", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-smag", "lsp_signature.nvim", "fidget.nvim", "nvim-lsp-installer" },
  ...
  ["vim-lark-syntax"] = {
    loaded = true,
    path = "C:\\Users\\thtom\\AppData\\Local\\nvim-data\\site\\pack\\packer\\start\\vim-lark-syntax",
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'gen_tags.vim', 'hop.nvim', 'kommentary', 'vim-quickhl', 'nvim-hlslens', 'vim-signify', 'lspkind-nvim', 'vim-smartchr', 'vim-translator', 'marks.nvim', 'vimdoc-ja', 'nvim-autopairs', 'nvim-scrollbar', 'nvim-notify', 'quick-scope', 'specs.nvim', 'vim-fugitive', 'clever-f.vim', 'tagbar', 'indent-guides.nvim', 'faster.nvim', 'asyncrun.vim', 'vim-cursorword'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
