...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-treesitter", "cmp-nvim-lua", "cmp-vsnip", "cmp-nvim-tags", "cmp-tabnine", "cmp-path" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-cursorword', 'auto-ctags.vim', 'vim-fugitive', 'vim-quickrun', 'vim-signify', 'clever-f.vim', 'hop.nvim', 'kommentary', 'vim-signature', 'vim-translator', 'vimdoc-ja', 'faster.nvim', 'tagbar', 'indent-guides.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
