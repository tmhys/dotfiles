...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp-vsnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-tags", "cmp-omni", "cmp-path", "cmp-nvim-lua", "cmp-spell", "cmp-tabnine" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-fugitive', 'indent-guides.nvim', 'vim-quickrun', 'marks.nvim', 'vim-translator', 'vimdoc-ja', 'kommentary', 'gen_tags.vim', 'tagbar', 'clever-f.vim', 'vim-signify', 'vim-cursorword', 'hop.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'faster.nvim', 'lspkind-nvim', 'specs.nvim', 'nvim-hlslens', 'nvim-autopairs'}, { event = "VimEnter *" }, _G.packer_plugins)]]
