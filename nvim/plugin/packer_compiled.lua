...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-nvim-tags", "cmp-spell", "cmp-omni" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-cursorword', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'vim-signify', 'vimdoc-ja', 'kommentary', 'clever-f.vim', 'asyncrun.vim', 'indent-guides.nvim', 'hop.nvim', 'vim-translator', 'nvim-scrollbar', 'nvim-hlslens', 'nvim-notify', 'specs.nvim', 'tagbar'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
