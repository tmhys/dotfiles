...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp-tabnine", "cmp-cmdline", "cmp-treesitter", "cmp-vsnip", "cmp-nvim-tags", "cmp-nvim-lua" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'clever-f.vim', 'vim-quickrun', 'vim-signature', 'vim-signify', 'vim-translator', 'kommentary', 'faster.nvim', 'tagbar', 'hop.nvim', 'auto-ctags.vim', 'indent-guides.nvim', 'vim-cursorword', 'vimdoc-ja', 'vim-fugitive'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
