...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-tags", "cmp-vsnip", "cmp-cmdline", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-omni", "cmp-treesitter", "cmp-spell" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-smag", "fidget.nvim", "nvim-lsp-installer", "lsp_signature.nvim" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-signify', 'nvim-hlslens', 'Shade.nvim', 'asyncrun.vim', 'modes.nvim', 'mkdir.nvim', 'marks.nvim', 'vim-gutentags', 'indent-blankline.nvim', 'vim-fugitive', 'hop.nvim', 'stickybuf.nvim', 'faster.nvim', 'tagbar', 'kommentary', 'clever-f.vim', 'specs.nvim', 'vim-print-debug', 'quick-scope', 'vimdoc-ja', 'nvim-notify', 'vim-repeat'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'vim-smartchr', 'vim-vsnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
