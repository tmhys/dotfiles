...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp-vsnip", "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-nvim-tags" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "nvim-gps", "nvim-lsp-installer", "nvim-lsp-smag", "lsp_signature.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-smartchr', 'nvim-cmp', 'vim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'quick-scope', 'asyncrun.vim', 'faster.nvim', 'specs.nvim', 'tagbar', 'hop.nvim', 'nvim-hlslens', 'vim-cursorword', 'indent-guides.nvim', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'vim-translator', 'nvim-scrollbar', 'clever-f.vim', 'nvim-notify', 'kommentary', 'vimdoc-ja', 'vim-signify'}, { event = "CursorHold *" }, _G.packer_plugins)]]
