...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-nvim-tags" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-lsp-smag", "nvim-lsp-installer", "fidget.nvim", "nvim-gps" },
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'indent-guides.nvim', 'specs.nvim', 'tagbar', 'asyncrun.vim', 'vim-cursorword', 'vim-fugitive', 'vim-quickhl', 'clever-f.vim', 'vim-translator', 'vimdoc-ja', 'kommentary', 'nvim-hlslens', 'nvim-notify', 'vim-gutentags', 'faster.nvim', 'vim-signify', 'hop.nvim', 'quick-scope', 'nvim-scrollbar'}, { event = "CursorHold *" }, _G.packer_plugins)]]
