...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-vsnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp-tabnine", "cmp-treesitter" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'auto-pairs', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-translator', 'auto-ctags.vim', 'vimdoc-ja', 'vim-signify', 'clever-f.vim', 'tagbar', 'hop.nvim', 'vim-cursorword', 'vim-fugitive', 'kommentary', 'indent-guides.nvim', 'vim-quickrun', 'vim-signature', 'faster.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
