...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-nvim-tags", "cmp-vsnip", "cmp-cmdline", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-spell", "cmp-omni", "cmp-treesitter" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "nvim-lsp-smag", "lsp_signature.nvim", "fidget.nvim" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'marks.nvim', 'vim-gutentags', 'vim-fugitive', 'indent-blankline.nvim', 'hop.nvim', 'faster.nvim', 'nvim-hlslens', 'stickybuf.nvim', 'specs.nvim', 'quick-scope', 'asyncrun.vim', 'clever-f.vim', 'tagbar', 'kommentary', 'Shade.nvim', 'vimdoc-ja', 'nvim-notify', 'modes.nvim', 'vim-signify', 'mkdir.nvim', 'vim-repeat'}, { event = "VimEnter *" }, _G.packer_plugins)]]
