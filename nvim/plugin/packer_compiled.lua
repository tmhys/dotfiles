...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-tags", "cmp-nvim-lua", "cmp-omni", "cmp-tabnine", "cmp-path", "cmp-treesitter", "cmp-vsnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-smag", "fidget.nvim", "lsp_signature.nvim", "nvim-lsp-installer" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-quickhl', 'hop.nvim', 'vim-cursorword', 'indent-guides.nvim', 'vim-fugitive', 'vim-signify', 'vim-smartchr', 'asyncrun.vim', 'kommentary', 'nvim-hlslens', 'clever-f.vim', 'nvim-notify', 'vim-translator', 'vimdoc-ja', 'vim-gutentags', 'quick-scope', 'specs.nvim', 'nvim-scrollbar', 'faster.nvim', 'tagbar'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
