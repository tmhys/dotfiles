...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-tags", "cmp-buffer", "vim-vsnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-tabnine", "cmp-vsnip", "cmp-treesitter" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'hop.nvim', 'indent-guides.nvim', 'vim-cursorword', 'clever-f.vim', 'vim-signature', 'vim-signify', 'tabline.nvim', 'auto-ctags.vim', 'vim-translator', 'vimdoc-ja', 'faster.nvim', 'vim-quickrun', 'tagbar', 'vim-fugitive', 'kommentary'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
