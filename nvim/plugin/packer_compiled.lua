...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-spell", "cmp-cmdline", "cmp-nvim-tags" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-gps", "lsp_signature.nvim", "nvim-lsp-smag", "fidget.nvim", "nvim-lsp-installer" },
  ...
  ["seq.vim"] = {
    ...
    url = "https://github.com/C:/Users/thtom/seq.vim"
  },
  ["specs.nvim"] = {
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'vim-fugitive', 'vim-quickhl', 'kommentary', 'vim-signify', 'vim-translator', 'nvim-notify', 'vimdoc-ja', 'asyncrun.vim', 'nvim-hlslens', 'faster.nvim', 'quick-scope', 'nvim-scrollbar', 'indent-guides.nvim', 'vim-cursorword', 'specs.nvim', 'clever-f.vim', 'tagbar', 'vim-gutentags', 'hop.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-smartchr', 'vim-surround', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
