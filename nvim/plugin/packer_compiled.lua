...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-omni", "cmp-nvim-lua", "cmp-buffer", "cmp-nvim-tags", "cmp-vsnip", "cmp-path", "cmp-cmdline", "cmp-spell", "cmp-tabnine", "cmp-treesitter" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lsp_signature.nvim", "nvim-lsp-smag", "nvim-lsp-installer" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'tagbar', 'faster.nvim', 'vim-cursorword', 'gen_tags.vim', 'vim-fugitive', 'vim-quickhl', 'lspkind-nvim', 'marks.nvim', 'nvim-scrollbar', 'nvim-hlslens', 'nvim-autopairs', 'nvim-notify', 'vim-signify', 'vim-smartchr', 'specs.nvim', 'asyncrun.vim', 'kommentary', 'vim-translator', 'vimdoc-ja', 'quick-scope', 'clever-f.vim', 'indent-guides.nvim', 'hop.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
