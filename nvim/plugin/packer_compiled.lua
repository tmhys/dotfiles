...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-omni", "cmp-path", "cmp-spell", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-buffer" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-smag", "nvim-lsp-installer", "lsp_signature.nvim", "fidget.nvim", "nvim-gps" },
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-scrollbar', 'clever-f.vim', 'nvim-notify', 'quick-scope', 'faster.nvim', 'hop.nvim', 'vim-quickhl', 'indent-guides.nvim', 'asyncrun.vim', 'vim-signify', 'kommentary', 'vim-translator', 'specs.nvim', 'nvim-hlslens', 'tagbar', 'vim-fugitive', 'vim-gutentags', 'vimdoc-ja', 'vim-cursorword'}, { event = "CursorHold *" }, _G.packer_plugins)]]
