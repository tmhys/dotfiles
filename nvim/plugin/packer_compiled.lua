...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-tags", "cmp-omni", "cmp-treesitter", "cmp-vsnip", "cmp-spell", "cmp-tabnine", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-smag", "nvim-lsp-installer", "lsp_signature.nvim" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'clever-f.vim', 'tagbar', 'vim-cursorword', 'vim-fugitive', 'vim-quickrun', 'kommentary', 'vim-signify', 'hop.nvim', 'indent-guides.nvim', 'vim-translator', 'vimdoc-ja', 'marks.nvim', 'gen_tags.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'specs.nvim', 'lspkind-nvim', 'nvim-autopairs', 'nvim-hlslens', 'faster.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
