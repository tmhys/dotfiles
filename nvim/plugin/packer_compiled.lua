...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-tags", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-nvim-lua" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'indent-guides.nvim', 'nvim-notify', 'nvim-hlslens', 'asyncrun.vim', 'specs.nvim', 'clever-f.vim', 'tagbar', 'vim-cursorword', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'vim-signify', 'hop.nvim', 'vim-smartchr', 'faster.nvim', 'kommentary', 'vim-translator', 'nvim-scrollbar', 'quick-scope', 'vimdoc-ja'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
