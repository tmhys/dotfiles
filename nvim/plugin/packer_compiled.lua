...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-spell", "cmp-buffer", "cmp-nvim-tags", "cmp-cmdline" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "nvim-gps", "lsp_signature.nvim", "nvim-lsp-smag", "nvim-lsp-installer" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'specs.nvim', 'vim-smartchr', 'tagbar', 'vimdoc-ja', 'nvim-hlslens', 'nvim-scrollbar', 'indent-guides.nvim', 'vim-cursorword', 'nvim-notify', 'vim-signify', 'vim-translator', 'vim-fugitive', 'vim-gutentags', 'kommentary', 'asyncrun.vim', 'clever-f.vim', 'hop.nvim', 'vim-quickhl'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
