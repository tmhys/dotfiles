...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-tabnine", "cmp-treesitter", "cmp-omni", "cmp-vsnip", "cmp-path", "cmp-nvim-tags", "cmp-spell" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-gps", "lsp_signature.nvim", "fidget.nvim", "nvim-lsp-installer", "nvim-lsp-smag" },
  ...
  ["nvim-treesitter"] = {
    config = { "\27LJ\2\n5\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\26my_plugins.treesitter\frequire\0" },
    loaded = true,
    path = "C:\\Users\\thtom\\AppData\\Local\\nvim-data\\site\\pack\\packer\\start\\nvim-treesitter",
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'specs.nvim', 'tagbar', 'vim-cursorword', 'vim-fugitive', 'vim-gutentags', 'nvim-hlslens', 'vim-quickhl', 'asyncrun.vim', 'kommentary', 'hop.nvim', 'vim-translator', 'nvim-scrollbar', 'clever-f.vim', 'vimdoc-ja', 'indent-guides.nvim', 'vim-signify', 'nvim-notify'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'vim-smartchr', 'vim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'quick-scope', 'faster.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
