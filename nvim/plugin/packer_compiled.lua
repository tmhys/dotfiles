...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-vsnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-omni", "cmp-tabnine", "cmp-spell", "cmp-path", "cmp-treesitter" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "fidget.nvim", "nvim-lsp-smag", "nvim-lsp-installer" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-cursorword', 'vim-fugitive', 'vim-quickhl', 'vim-signify', 'faster.nvim', 'clever-f.vim', 'indent-guides.nvim', 'nvim-notify', 'vim-gutentags', 'vim-translator', 'vimdoc-ja', 'asyncrun.vim', 'quick-scope', 'kommentary', 'hop.nvim', 'specs.nvim', 'nvim-hlslens', 'nvim-scrollbar', 'tagbar', 'vim-smartchr'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
