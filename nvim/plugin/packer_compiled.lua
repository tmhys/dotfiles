...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-omni", "cmp-vsnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lsp_signature.nvim", "nvim-lsp-smag", "nvim-lsp-installer", "nvim-gps" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'vim-vsnip', 'vim-smartchr', 'vim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-notify', 'hop.nvim', 'indent-guides.nvim', 'quick-scope', 'specs.nvim', 'tagbar', 'vim-cursorword', 'vim-fugitive', 'kommentary', 'vim-gutentags', 'vim-quickhl', 'vim-signify', 'asyncrun.vim', 'faster.nvim', 'vimdoc-ja', 'clever-f.vim', 'vim-translator', 'nvim-scrollbar', 'nvim-hlslens'}, { event = "CursorHold *" }, _G.packer_plugins)]]
