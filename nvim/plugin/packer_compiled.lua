...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-vsnip", "cmp-path", "cmp-treesitter", "cmp-tabnine", "cmp-omni" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "nvim-lsp-installer", "lsp_signature.nvim", "nvim-lsp-smag" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-signify', 'vim-repeat', 'vim-gutentags', 'vim-fugitive', 'nvim-notify', 'clever-f.vim', 'stickybuf.nvim', 'specs.nvim', 'Shade.nvim', 'Comment.nvim', 'asyncrun.vim', 'modes.nvim', 'mkdir.nvim', 'marks.nvim', 'tagbar', 'nvim-hlslens', 'indent-blankline.nvim', 'kommentary', 'faster.nvim', 'vimdoc-ja', 'hop.nvim', 'quick-scope', 'vim-print-debug'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-smartchr', 'vim-surround', 'vim-vsnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
