...
_G.packer_plugins = {
  ...
  ["neotags.nvim"] = {
    config = { "\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23my_plugins.neotags\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-spell", "cmp-tabnine", "cmp-omni", "cmp-treesitter", "cmp-vsnip", "cmp-path" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'faster.nvim', 'hop.nvim', 'indent-guides.nvim', 'nvim-scrollbar', 'marks.nvim', 'nvim-notify', 'vim-cursorword', 'vim-fugitive', 'specs.nvim', 'clever-f.vim', 'vim-quickhl', 'quick-scope', 'vim-signify', 'nvim-hlslens', 'vim-smartchr', 'kommentary', 'vim-translator', 'vimdoc-ja', 'tagbar', 'neotags.nvim', 'asyncrun.vim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
