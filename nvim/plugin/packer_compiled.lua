...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-tags", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua" },
  ...
  tagbar = {
    config = { "\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23myj_plugins.tagbar\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-quickrun', 'vim-signature', 'vim-signify', 'faster.nvim', 'vim-translator', 'auto-ctags.vim', 'vimdoc-ja', 'hop.nvim', 'clever-f.vim', 'tagbar', 'vim-cursorword', 'indent-guides.nvim', 'vim-fugitive', 'kommentary'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
