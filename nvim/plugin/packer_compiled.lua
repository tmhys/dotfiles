...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-tags", "cmp-vsnip", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-buffer", "cmp-treesitter", "cmp-cmdline", "cmp-spell", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "lsp_signature.nvim", "nvim-lsp-smag", "nvim-gps", "nvim-lsp-installer" },
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'faster.nvim', 'hop.nvim', 'kommentary', 'indent-guides.nvim', 'quick-scope', 'specs.nvim', 'tagbar', 'vim-cursorword', 'nvim-scrollbar', 'asyncrun.vim', 'vimdoc-ja', 'vim-gutentags', 'vim-fugitive', 'vim-quickhl', 'nvim-notify', 'vim-translator', 'nvim-hlslens', 'clever-f.vim', 'vim-signify'}, { event = "CursorHold *" }, _G.packer_plugins)]]
