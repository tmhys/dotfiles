...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-nvim-tags", "cmp-treesitter", "cmp-nvim-lua", "cmp-vsnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-lsp-smag", "nvim-lsp-installer", "fidget.nvim" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'specs.nvim', 'asyncrun.vim', 'tagbar', 'hop.nvim', 'indent-guides.nvim', 'nvim-hlslens', 'clever-f.vim', 'vim-cursorword', 'vim-fugitive', 'marks.nvim', 'kommentary', 'nvim-scrollbar', 'vim-signify', 'nvim-notify', 'faster.nvim', 'nvim-autopairs', 'gen_tags.vim', 'vimdoc-ja', 'vim-translator', 'lspkind-nvim', 'vim-smartchr', 'vim-quickhl', 'quick-scope'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
