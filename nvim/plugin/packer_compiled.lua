...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-spell", "cmp-omni", "cmp-path", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-smag", "lsp_signature.nvim", "nvim-lsp-installer", "fidget.nvim" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'clever-f.vim', 'indent-guides.nvim', 'kommentary', 'specs.nvim', 'vim-cursorword', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'vim-signify', 'vim-smartchr', 'marks.nvim', 'vim-translator', 'vimdoc-ja', 'nvim-notify', 'asyncrun.vim', 'nvim-scrollbar', 'nvim-hlslens', 'faster.nvim', 'hop.nvim', 'tagbar', 'quick-scope'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
