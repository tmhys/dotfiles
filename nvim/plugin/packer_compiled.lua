...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-omni", "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-path" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-hlslens', 'clever-f.vim', 'nvim-notify', 'specs.nvim', 'tagbar', 'vim-cursorword', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'faster.nvim', 'vim-signify', 'vim-smartchr', 'hop.nvim', 'indent-guides.nvim', 'vimdoc-ja', 'nvim-scrollbar', 'kommentary', 'asyncrun.vim', 'vim-translator'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
