...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-omni", "cmp-spell", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "nvim-lsp-smag", "lsp_signature.nvim" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'kommentary', 'vim-translator', 'gen_tags.vim', 'hop.nvim', 'indent-guides.nvim', 'marks.nvim', 'tagbar', 'clever-f.vim', 'vim-cursorword', 'vim-fugitive', 'vim-quickrun', 'vimdoc-ja', 'vim-signify'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'faster.nvim', 'nvim-autopairs', 'nvim-hlslens', 'lspkind-nvim', 'nvim-notify', 'specs.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
