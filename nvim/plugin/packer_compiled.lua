...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-omni", "cmp-path", "cmp-spell", "cmp-tabnine", "cmp-vsnip", "cmp-treesitter" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-gps", "nvim-lsp-smag", "fidget.nvim", "nvim-lsp-installer" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-smartchr', 'hop.nvim', 'indent-guides.nvim', 'vim-translator', 'vimdoc-ja', 'clever-f.vim', 'nvim-scrollbar', 'asyncrun.vim', 'specs.nvim', 'tagbar', 'nvim-notify', 'vim-cursorword', 'kommentary', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'nvim-hlslens', 'vim-signify'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
