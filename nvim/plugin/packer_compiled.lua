...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-treesitter", "cmp-vsnip", "cmp-buffer", "cmp-path", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-cmdline", "cmp-spell", "cmp-omni" },
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'quick-scope', 'specs.nvim', 'faster.nvim', 'tagbar', 'hop.nvim', 'vim-cursorword', 'indent-guides.nvim', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'vim-signify', 'vim-translator', 'vim-smartchr', 'vimdoc-ja', 'nvim-scrollbar', 'nvim-hlslens', 'clever-f.vim', 'asyncrun.vim', 'kommentary', 'nvim-notify'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
