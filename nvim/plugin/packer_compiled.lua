...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-spell", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-treesitter", "cmp-nvim-tags", "cmp-vsnip", "cmp-omni", "cmp-path", "cmp-tabnine" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-lsp-smag", "nvim-lsp-installer", "nvim-gps", "fidget.nvim" },
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'hop.nvim', 'vim-cursorword', 'indent-guides.nvim', 'vim-fugitive', 'vim-gutentags', 'kommentary', 'vim-quickhl', 'nvim-notify', 'vim-signify', 'asyncrun.vim', 'vim-translator', 'clever-f.vim', 'vimdoc-ja', 'nvim-hlslens', 'quick-scope', 'tagbar', 'specs.nvim', 'nvim-scrollbar', 'faster.nvim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
