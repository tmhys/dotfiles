...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-omni", "cmp-tabnine", "cmp-treesitter", "cmp-spell", "cmp-buffer", "cmp-path", "cmp-vsnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "fidget.nvim", "nvim-gps", "nvim-lsp-smag", "lsp_signature.nvim" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'vim-smartchr', 'vim-surround', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'kommentary', 'nvim-hlslens', 'quick-scope', 'specs.nvim', 'tagbar', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'vim-signify', 'hop.nvim', 'indent-guides.nvim', 'vim-translator', 'vimdoc-ja', 'nvim-notify', 'vim-cursorword', 'asyncrun.vim', 'faster.nvim', 'nvim-scrollbar', 'clever-f.vim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
