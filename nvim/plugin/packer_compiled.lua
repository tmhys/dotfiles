...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-treesitter", "cmp-cmdline", "cmp-buffer", "cmp-tabnine", "cmp-omni", "cmp-nvim-tags", "cmp-path", "cmp-spell", "cmp-vsnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "lsp_signature.nvim", "fidget.nvim", "nvim-lsp-smag" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-hlslens', 'vim-signify', 'modes.nvim', 'vim-repeat', 'marks.nvim', 'vim-gutentags', 'vim-fugitive', 'tagbar', 'stickybuf.nvim', 'specs.nvim', 'faster.nvim', 'quick-scope', 'vimdoc-ja', 'nvim-notify', 'indent-blankline.nvim', 'clever-f.vim', 'kommentary', 'Shade.nvim', 'asyncrun.vim', 'hop.nvim', 'mkdir.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-cursorword'}, { event = "CursorHold *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-smartchr', 'vim-vsnip', 'vim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
