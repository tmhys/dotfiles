...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-lsp-smag", "fidget.nvim", "nvim-lsp-installer", "nvim-gps" },
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'quick-scope', 'asyncrun.vim', 'nvim-hlslens', 'specs.nvim', 'tagbar', 'nvim-scrollbar', 'vim-cursorword', 'vim-fugitive', 'vim-gutentags', 'vim-quickhl', 'vim-signify', 'vimdoc-ja', 'faster.nvim', 'kommentary', 'clever-f.vim', 'hop.nvim', 'nvim-notify', 'indent-guides.nvim', 'vim-translator'}, { event = "CursorHold *" }, _G.packer_plugins)]]
