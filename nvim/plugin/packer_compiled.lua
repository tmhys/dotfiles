...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-treesitter", "cmp-nvim-lua", "cmp-nvim-tags", "cmp-path", "cmp-tabnine", "cmp-vsnip" },
  ...
  ["seq.vim"] = {
    ...
    loaded = true,
    needs_bufread = true,
    path = "C:\\Users\\thtom\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\seq.vim",
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'vim-signify', 'auto-ctags.vim', 'vim-translator', 'clever-f.vim', 'vimdoc-ja', 'hop.nvim', 'tagbar', 'kommentary', 'marks.nvim', 'vim-fugitive', 'vim-cursorword', 'vim-quickrun', 'indent-guides.nvim'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
