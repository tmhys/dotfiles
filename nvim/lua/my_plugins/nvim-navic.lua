...
M.setup = function()
	...
	M.create_winbar()
	navic.setup(M.breadcrumbs.options)

	if M.breadcrumbs.on_config_done then
		M.breadcrumbs.on_config_done()
	end
end
...
local excludes = function()
	return vim.tbl_contains(M.breadcrumbs.winbar_filetype_exclude or {}, vim.bo.filetype)
end
