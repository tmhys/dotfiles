...
--     duplicates_default = 0,
--     format = function(entry, vim_item)
--       -- local max_width = test.formatting.max_width
--       local max_width = 0
--       if max_width ~= 0 and #vim_item.abbr > max_width then
--         vim_item.abbr = string.sub(vim_item.abbr, 1, max_width - 1) .. icons.ui.Ellipsis
--       end
--       vim_item.kind = icons.kind
--
...
--       end
--       -- vim_item.menu = test.formatting.source_names[entry.source.name]
--       -- vim_item.dup = test.formatting.duplicates[entry.source.name]
--         -- or 0
--       return vim_item
--     end,
--   },
...
--     ["<CR>"] = cmp.mapping(function(fallback)
--       if cmp.visible() then
--         -- local confirm_opts = vim.deepcopy(test.confirm_opts) -- avoid mutating the original opts below
...
--   cmp.setup(test)
--
--     for _, option in ipairs(test.cmdline.options) do
