return {
  lspconfig = {
    ...
    config = function()
      ...
      fn.sign_define("DiagnosticSignError", { texthl = "DiagnosticSignError", text = "Åú" })
      fn.sign_define("DiagnosticSignWarn", { texthl = "DiagnosticSignWarn", text = "Åõ" })
      fn.sign_define("DiagnosticSignInfo", { texthl = "DiagnosticSignInfo", text = "Å°" })
      fn.sign_define("DiagnosticSignHint", { texthl = "DiagnosticSignHint", text = "Å†" })
  ...
  mason_tool_installer = function()
    ...
    if is_over then
      ...
      vim.notify("Tools are old. UpdatingÅcÅc", vim.log.levels.WARN)
    end
